			...
			[
				{ 
					...
					children:[
						...
						{ path: 'sync-only-component',  component: SyncOnlyComponent, data:{title:'同步路由'} },
						...
						// 预加载
						{ path: 'preload', loadChildren: './router/preload/preload.module#Module', data:{ title:'预加载', preload:true } },
						// 惰性加载子组件
						...
						{ 
							...
							resolve: { data:AuthGuard }, // 将守卫上的数据绑定到 route 的 data 上
							children:[
								{
									path:'',
						...
						// ngrx
						{ path: 'ngrx',  component: NgrxComponent, data:{title:'gnrx 状态管理'} },
						// typescript
